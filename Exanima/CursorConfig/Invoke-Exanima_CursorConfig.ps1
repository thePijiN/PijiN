...
$LauncherName = 'Exanima Cursor Config'
$ScriptUri = 'https://raw.githubusercontent.com/thePijiN/PijiN/refs/heads/main/Exanima/CursorConfig/Exanima_CursorConfig.ps1'
